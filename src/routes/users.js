...
import { createUserValidators,updateUserValidators, runValidations } from '../middlewares/validators.js';
...
router.put('/:id_usuario', runValidations(updateUserValidators), userController.putActualizarUsuario);
